...
urlpatterns = [
    ...
    path('blocked-time/', views.BlockedTimeListView.as_view(), name='blocked_time_list'),
    path('blocked-time/<int:pk>/update/', views.BlockedTimeUpdateView.as_view(), name='blocked_time_update'),
    path('blocked-time/<int:pk>/delete/', views.BlockedTimeDeleteView.as_view(), name='blocked_time_delete'),
